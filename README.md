...
Package metadata: `dsh-notifier@0.13.0` · 1985 automated contract tests · MIT licensed.
...
v0.13.0 convergence line: **1985 registered contract tests**; the full hermetic suite passes, while real-provider/device evidence remains an external gate.

test/ 1985 tests in the current line; the historical 0.8.6 package carried 909 tests.
