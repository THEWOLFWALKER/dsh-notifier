...
如果升级后你仍看到“出站必须重启才能生效”，先怀疑实际运行的不是 registry `0.13.1` 或更高版本。
...
| CLI | `npm ls dsh-notifier` / `pnpm ls dsh-notifier` | `0.13.1`（或更高） |
...
dshQuality.testCount = 2011    # v0.13.1 发布线；上一发布线 v0.13.0 快照为 1985
```
